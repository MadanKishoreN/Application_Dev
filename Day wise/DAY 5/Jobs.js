...
//           <Typography variant="body2">{job.job_responsibility}</Typography>
//           <Typography variant="h6">Educational Requirements</Typography>
//           <Typography variant="body2">{job.educational_requirements}</Typography>
//           <Typography variant="h6">Experiences</Typography>
//           <Typography variant="body2">{job.experiences}</Typography>
//           <Typography variant="h6">Contact Information</Typography>
//           <Typography variant="body2">Phone: {job.contact_information.phone}</Typography>
//           <Typography variant="body2">Email: {job.contact_information.email}</Typography>
//         </Grid>
...
//           <Typography variant="body2">{job.remote_or_onsite}</Typography>
//           <Typography variant="body2">{job.location}</Typography>
//           <Typography variant="body2">{job.fulltime_or_parttime}</Typography>
